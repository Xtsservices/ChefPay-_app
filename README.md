...
<!-- untill 1st run it should be false -->

newArchEnabled=false

<!-- after 1st run make it true -->
...
First, you will need to start _Metro_, the JavaScript bundler that ships with React Native.
